...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $Total_MaterialDetails = \App\Models\MaterialDetail::count();
        return view('home',compact('Total_SalesInvoices','Total_UnSignedInvoices','Total_SignedInvoices','Total_MaterialDetails'));
