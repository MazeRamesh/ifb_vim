...
@section('page-title','Vchtypes Edit')
			...
			<div class="row">
				<div class="col-12">
					<div class="card card-primary card-outline">
						<form method="POST" action="{{ route('vchtypes.vchtypes.update', $vchtypes->id) }}" id="edit_vchtypes_form" name="edit_vchtypes_form" accept-charset="UTF-8" class="form-horizontal">
							<div class="card-header">
								<h3 class="card-title clearfix">
								   {{ !empty($title) ? $title : 'Vchtypes' }}
