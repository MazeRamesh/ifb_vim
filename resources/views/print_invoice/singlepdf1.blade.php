...
<tr>
        ...
        <tr>
            ...
            <th rowspan="6" colspan="4" style="padding: 0px;margin:0px;">
                <?php $image_path = '/app/Barcode.png'; ?>
                <img src="{{ storage_path() . $image_path }}" alt=""style="width:120px;height:120px; margin-top:20px;"srcset="">
           ...
           &nbsp;
           &nbsp;
           <?php $image_path = '/app/IRN_Barcode.png'; ?>
           <img src="{{ storage_path() . $image_path }}" alt=""style="width:120px; margin-top:20px;"srcset="">
