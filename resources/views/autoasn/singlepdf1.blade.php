...
<img src="{{ public_path() . $image_path }}" alt="" srcset="" style="width:225px;"> </td>
   <td style="width: 33%;"> <b style="font-size: 12px;">ITW INDIA PRIVATE LIMITED</b> <br>
      G-65,SIPCOT INDUSTRIAL PARK <br>
     Vallam Vadagal, Sriperumbudur, <br>Kanchipuram District<br>
     Tamil Nadu 602105, <br>
     India</td>
     <td style="width: 33%;">  <b style="font-size: 10px;"> GST Invoice No.</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b style="font-size: 10px;">: {{$fulldata[0]->invoice_no}}</b> <br>
   ...
   <td style="font-weight: bold;">Vendor Code :&nbsp;T07O</td>
   </tr>
   </tbody>
   </table>
   <!-- DivTable.com -->
...
<tr style="font-size: 8px;"> 
            <td style="border-top: 0ch;border-bottom:0ch;width: 2%;height: 20px;"></td>
   ...
   <table style="width: 100%;border-collapse:collapse;border-top: 0ch;" valign="top"border="1" style="" >
      ...
      <tr style="padding-top:0px;padding-left: 0px;">
         ...
         <table style="width: 100%;border-collapse:collapse;border-top: 0ch;" border="1" style="" >
            <tbody>
            <tr>
            <td style="width: 22.3%;padding: 10px;padding-top:0px;">    
      <p style="text-align:center;padding:0px;">{{$fulldata[0]->invoice_no}}</p>
<?php $img_path = '/app/Barcode.png'; ?>
<img src="{{ storage_path() . $img_path }}" alt="" style="width: 190px;"></td>
            <td style="width: 33%;padding: 4px;
    vertical-align: baseline;"><
               
            
            <div style="width: 99%;text-align:justify;clear:both;padding:2px;vertical-align:baseline;"> <b>  Terms:</b> &nbsp;&nbsp;&nbsp;All Claims and disputes arising out of contracts made by us
...
<b>for ITW INDIA PVT.LTD</b>               
            ...
            <div style="text-align: center;padding-top: 140px;width: 100%;">
