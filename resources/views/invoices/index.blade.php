                ...
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('invoices.create') }}" class="btn btn-info btn-fill"><i class="fa fa-upload"></i>
                                Upload</a>
                            <a href="{{ URL::to('downloadInvoice') }}"><button class="btn btn-success"><i
                                        class="fa fa-download"></i> Export </button></a>
