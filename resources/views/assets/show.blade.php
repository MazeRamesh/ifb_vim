    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
				...
				<div class="card card-primary card-outline">
					<div class="card-header">
						<h3 class="card-title clearfix">
						   {{ isset($asset->name) ? $asset->name : 'Asset' }}
            ...
            <dd class="col-md-8 col-sm-6">{{ $asset->name }}</dd>
		</dl>
		<dl class="row lp-2">
            <dt class="col-md-3 col-sm-5">Description</dt>
            <dd class="col-md-8 col-sm-6">{{ $asset->description }}</dd>
		</dl>
		<dl class="row lp-2">
            <dt class="col-md-3 col-sm-5">Location</dt>
            <dd class="col-md-8 col-sm-6">{{ $asset->location }}</dd>
		</dl>
		<dl class="row lp-2">
            <dt class="col-md-3 col-sm-5">Email</dt>
            <dd class="col-md-8 col-sm-6">{{ $asset->email }}</dd>
		</dl>
