...
@section('page-title','Locationwise Report')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Locationwise Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
			  <li class="breadcrumb-item active">Locationwise Report</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
			...
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Locationwise Report</h3>
...
<div class="col-3 form-group">
    <label class="col control-label">Location: </label>
<select class="form-control" id="locationcode" name="locationcode" required="">
<option value="" style="display: none;" disabled selected>Select Location</option>
<option value="all">All</option> 
@foreach ($location as $key => $locations)
<option value="{{ $locations->locationcode }}">
...
@endforeach
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped " style="width:100%" id="locationwiseReport_table">
                    <thead>
                        <tr>
                            <th>Invoice No</th>
                            <th>Invoice Date</th>
...
<script>
	var reg_table;
$(function() {
reg_table=$('#locationwiseReport_table').DataTable({
processing: true,
searching: true,
serverSide: true,
dom: 'lBfrtip',
...
ajax:{"url": '{!! route('get.locationwisereport.data') !!}',

'data':function ( d ) {
                        d.fromdate=$("#fromdate").val();
                        d.todate=$("#todate").val();
                        d.locationcode=$("#locationcode").val();
...
{ data: 'createdlocation', name: 'createdlocation' },
...
$('#locationwiseReport_table-table').DataTable().draw(false);
}
);
}
});
...
$("#fromdate,#todate,#locationcode").on('change',function(){
    reg_table.draw();
});
