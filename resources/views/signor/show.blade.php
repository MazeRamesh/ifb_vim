...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row" style="padding-top: 10px;">
           ...
           <form role="form" action="{{ route('print.sign.pdf') }}" method="POST" id="myForm" autocomplete="off" target="_blank">
                        {!! csrf_field() !!}
  ...
  <br>
   <input name="invoicenumber" id="invoicenumber" value="{{$salesheader->invoiceno}}" style="display: none;"/>
   <input name="invoiceto" id="invoiceto" value="{{$salesheader->invoiceto}}" style="display: none;"/>
 <!--   <input name="all" id="all" style="display: none;"/>
   ...
   <div class="card-body">
        ...
        <div class="card-text">
            ...
            <dt class="col">Total Tax</dt>
            <dd class="col">{{ $salesheader->taxamounts }}</dd>
            <dt class="col">Net Amount</dt>
            <dd class="col">{{ $salesheader->taxableamounts }}</dd>
            <dt class="col">CGST Amount</dt>
            <dd class="col">{{ $salesheader->sales_total }}</dd>
            ...
            @foreach($salesheader->InvoicenoList as $salesheader)
                        <tbody>
                            <tr>
                                ...
                                <td style="width:15%;">{{$salesheader->HMILPartNo}}</td>
                                <td style="width:15%;">{{$salesheader->productdescription}}</td>
                                <td style="width:15%;">{{$salesheader->HASNorSACcode}}</td>
                                ...
                                <td style="width:15%;">{{$salesheader->totallinevalue}}</td>
