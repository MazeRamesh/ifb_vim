@extends('layouts.app')
@section('content')
@section('digitalsigner','menu-open')
@push('css')
...
<div class="content-wrapper">
    ...
    <label class="lab">From Date<b class="imp">*</b></label>
                                        <input id="fromdate" style="border: 0px;border-bottom: 2px solid blue;" class="from" name="fromdate"  placeholder="From date" autocomplete="off" ng-model="fromdate" ng-change="changedate()">
                                    </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group clearfix{{ $errors->has('fromdate') ? 'has-error' : '' }}">
...
<div class="form-group clearfix{{ $errors->has('fromdate') ? 'has-error' : '' }}">
    <label class="lab">From Date<b class="imp">*</b></label>
    <input id="datepicker" class="from" name="fromdate" style="border: 0px;border-bottom: 2px solid blue;"   placeholder="From date" autocomplete="off" ng-model="from" ng-change="changedateunsigned()">
</div>
</div>
                                        <div class="col-md-3">
<div class="form-group clearfix{{ $errors->has('todate') ? 'has-error' : '' }}">
 ...
 <form role="form" action="{{ route('readytosign.pdf') }}" method="POST" id="readyforsignform" autocomplete="off" style="padding-bottom: 10px;">
                                        ...
                                        <div id="single">
                                            <button type="button" class="ng-hide btn btn-success btn-sm pl-4 pr-4" id="readytosign" disabled>Click here to Sign</button>
                                             <input name="invoices" id="invoices" style="display: none;" />
                                        </div>


                                        </form>
                                           <form role="form" action="{{ route('sign.pdf') }}" method="POST" id="signform" autocomplete="off" style="display: none;">
                                        {!! csrf_field() !!}


                                        <div class="col-md-4" style="padding-bottom: 15px;" id="signbutton" >
                                            <div class=" row button">
                                            <button type="button" class=" btn btn-success btn-sm pl-4 pr-4" id="sign" disabled>Click here to Sign</button>
         ...
         <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
          <div  class="tab-pane fade show active" id="nav-UnSingned" role="tabpanel" aria-labelledby="nav-UnSingned-tab">
                                  <div class="table-responsive mt-4">
                                    ...
                                    <table id="print_table" class="table table-bordered" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>S.No</th>
                                                <th>Inv.No</th>
...
table = $('#print_table').DataTable({
        ...
        serverSide: true,
        ajax:{
            'url':'{!! route('get.signor.data') !!}',
            'data':function(d){
                console.log($scope.from,$scope.to);
                d.fromdate=$scope.from;
                d.todate=$scope.to;
                return d;
            }
        },
