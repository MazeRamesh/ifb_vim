...
@section('content')
    ...
    <style>
        ...
        .fp-floating-label--focused,
        .fp-floating-label--valued {
            font-size: 0.85rem;
            color: inherit;
        }
    </style>
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="col-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="panel">
                                ...
                                <div class="container" style="padding-bottom: 10px;" id="uploaddiv">
                                    ...
                                    <form style="margin-top: 15px;padding: 10px;padding-top:0px;"
                                        action="{{ route('salesheaders.salesheader.importExcel') }}" class="form-horizontal"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 border border-right-0 p-3">
                                                ...
                                                <div
                                                    class="form-group clearfix{{ $errors->has('selectcompany') ? 'has-error' : '' }}">
                                                    <label class="lab">Select File<b class="imp">*</b></label> <br>
                                                    <input type="file" name="import_file"
                                                        accept=".xlsx, .xls, .csv, .CSV" />

                                                    <span style=""><button class="btn btn-md"
                                                            style="background: #2832ab;   padding-bottom: 3px;
                                                            margin-top: 15px;
                                                            padding-top: 0px;
                                                            padding-left: 30px;
                                                            padding-right: 30px;">
                                                            <!--<i class="fa fa-upload waves-effect waves-light" style="font-size: 18px;color:white;"></i>-->
                                                            <span style="color:white; text-transform:none">Upload</span>
                                                        </button>
                                ...
                                <div class="container" style="padding-bottom: 10px; display: none;" id="importdiv">
                                    ...
                                    <form id="invoice_form" style="padding-top: 10px;"
                                        action="{{ route('salesheaders.salesheader.importExcelstore') }}"
                        ...
                        <th>Description</th> --}}
                                            ...
                                            <tbody>
                                                <tr ng-repeat-start="invoice in invoices"
                                                    ng-init="$last && triggerChange()">
                                                    <td style="width:5%">
                                                        @{{ $index + 1 }}
                                                    </td>
                                                    <td style="width:10%">
                                                    ...
                                                    <td style="width:15%">
                                                        <input type="text" style="display: none" name="material_no[]"
                                                            ng-model="invoice.material_code" />
                                                        <selectize name="material_no[]"
                                                            style="width:100%;height:36px !important;"
                                                            config="mMaterialConfig" options='mMaterials'
                                                            ng-model="invoice.material_code"></selectize>
                                                    </td>
                                                    <td style="width:15%">
                                                        <input type="text" style="display: none" name="partno[]"
                                                            ng-model="invoice.part_no" />
                                                        <selectize name="partno[]"
                                                            style="width:100%;height:36px !important;"
                                                            config="mPartNoConfig" options='mMaterials'
                                                            ng-model="invoice.part_no"></selectize>
                                                    </td>
                                                    <td style="width:15%">
                                                        <input type="text" style="display: none"
                                                            name="customer_partno[]"
                                                            ng-model="invoice.customer_part_no" />
                                                        <selectize required name="customer_partno[]"
                                                            style="width:100%;height:36px !important;"
                                                            config="mCustomerPartNoConfig" options='mMaterials'
                                                            ng-model="invoice.customer_part_no"></selectize>
                                                    </td>
                                                    <td style="width:15%">
                                                        <input type="text" style="display: none" name="shop_code[]"
                                                            ng-model="invoice.shop_code" />
                                                        <selectize required name="shop_code[]"
                                                            style="width:100%;height:36px !important;"
                                                            config="mShopCodeConfig" options='mMaterials'
                                                            ng-model="invoice.shop_code"></selectize>
                                                    </td>
                                                    <td style="width:15%">
                                                        <input type="text" style="display: none" name="shop[]"
                                                            ng-model="invoice.shop" />
                                                        <selectize name="shop[]"
                                                            style="width:100%;height:36px !important;"
                                                            config="mShopConfig" options='mMaterials'
                                                            ng-model="invoice.shop"></selectize>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7">
                                                        ...
                                                        <div class="row py-2">
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Gate</label>
                                                                <input type="text" style="display: none"
                                                                    name="gate[]" ng-model="invoice.gate" />
                                                                <selectize class="fp-advanced-select" name="gate[]"
                                                                    style="width:100%;height:36px !important;"
                                                                    config="mGateConfig" options='mMaterials'
                                                                    ng-model="invoice.gate"></selectize>
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Box
                                                                    Qty</label>
                                                                <input type="text" style="display: none"
                                                                    name="box_qty[]" ng-model="invoice.box_qty" />
                                                                <selectize class="fp-advanced-select" name="box_qty[]"
                                                                    style="width:100%;height:36px !important;"
                                                                    config="mBoxQtyConfig" options='mMaterials'
                                                                    ng-model="invoice.box_qty"></selectize>
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Status</label>
                                                                <span ng-bind-html="invoice.status_html"></span>
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">HSN</label>
                                                                <input type="text" style="display: none"
                                                                    name="hsncode[]" ng-model="invoice.hsncode" />
                                                                <selectize class="fp-advanced-select" name="hsncode[]"
                                                                    style="width:100%;height:36px !important;"
                                                                    config="mHSNConfig" options='mMaterials'
                                                                    ng-model="invoice.hsncode"></selectize>
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Gst
                                                                    In</label>
                                                                <input type="text" style="display: none"
                                                                    name="gst_in[]" ng-model="invoice.gst_in" />
                                                                <selectize class="fp-advanced-select" name="gst_in[]"
                                                                    style="width:100%;height:36px !important;"
                                                                    config="mGSTINConfig" options='mMaterials'
                                                                    ng-model="invoice.gst_in"></selectize>
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Description</label>
                                                                <input type="text" style="display: none"
                                                                    name="product_desc[]"
                                                                    ng-model="invoice.product_desc" />
                                                                <selectize class="fp-advanced-select"
                                                                    name="product_desc[]"
                                                                    style="width:100%;height:36px !important;"
                                                                    config="mProductDescConfig" options='mMaterials'
                                                                    ng-model="invoice.product_desc"></selectize>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr ng-repeat-end>
                                                    <td colspan="7">
                                                        <div class="row py-2">
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">No
                                                                    Of Container</label>
                                                                <input class="form-control" type="number"
                                                                    name="stuff_qtys[]" min=0
                                                                    ng-model="invoice.stuff_qty" />
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">TCS
                                                                    Amount</label>
                                                                <input class="form-control" min=0 type="number"
                                                                    step=".01" name="tcs_amount[]" value="0.00"
                                                                    ng-model="invoice.tcs_amount" required />
                                                            </div>
                                                            {{-- Ram Added --}}
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Total Qty</label>
                                                                <input class="form-control" type="text" name="tot_qty[]"
                                                                    ng-model="invoice.productqty" required />
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Vehicle
                                                                    No</label>
                                                                <input class="form-control" type="text"
                                                                    name="vehicle_no[]" ng-model="invoice.vehicle_no"
                                                                    required />
                                                            </div>
                                                            <div class="col-2">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">Ewaybill
                                                                    No</label>
                                                                <input class="form-control" type="text"
                                                                    name="ewaybillno[]" ng-model="invoice.ewaybillno"
                                                                    required />
                                                            </div>
                                                            <div class="col-4">
                                                                <label
                                                                    class="fp-floating-label fp-floating-label--valued">IRN
                                                                    Number</label>
                                                                <input class="form-control" type="text" maxlength="64"
                                                                    minlength="64" name="irn_reference_no[]"
                                                                    ng-model="invoice.data.irn" required />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        @if ($current_page_count > 0)
                                            <div class="row">
                                                <div class="col-md-12 text-right"><b>Showing {{ $current_page_starting }}
                                                        to {{ $current_page_count }} of {{ $total_invoices }} Invoices</b>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <div style="padding-top: 0px;">
                                            <center><button type="submit"
                                                    style="background-color: #3d48ca;
        color: white;
        border: 0px;"
                                                    class="btn btn-info btn-md">Import</button>
                                                <input type="submit" onclick="return confirmCancel()"
                                                    class="btn btn-warning btn-md"
                                                    style="border: 1px solid #535ee3;
    background: azure;"
        ...
        app.controller('ImportController', function($scope, $http, $timeout) {
            ...
            $scope.mPartNoConfig = {
                ...
                onChange: function(selectize, selectize_instance) {
                    ...
                    $scope.invoices[index].stuff_qty = Math.ceil($scope.invoices[index].productqty / $scope
                        .invoices[index].box_qty);
            ...
            $scope.mCustomerPartNoConfig = {
                ...
                onChange: function(selectize, selectize_instance) {
                    ...
                    $scope.invoices[index].material_code = material_detail.material_code;
                    MaterialSelectize[index].setValue(material_detail.material_code, true);
                    $scope.invoices[index].part_no = material_detail.part_no + '-' + material_detail
                        .plant_code;
                    PartNoSelectize[index].setValue(material_detail.part_no + '-' + material_detail
                        .plant_code, true);
                    $scope.invoices[index].shop_code = material_detail.shop_code;
                    ShopCodeSelectize[index].setValue(material_detail.shop_code, true);
                    $scope.invoices[index].shop = material_detail.shop;
            ...
            $scope.mMaterialConfig = {
                ...
                onChange: function(selectize, selectize_instance) {
                    var index = ($(selectize_instance.$control[0]).closest('tr').index());
                    index = index / 3;
                    console.log($(selectize_instance.$control[0]).closest('tr'), $(selectize_instance
                        .$control[0]).closest('tr').index());
                    // return ;
                    material_detail = $scope.mMaterials.find(row => {
