...
app.controller('PoHeaderInventoryController', function($scope,$http,$filter,$compile) {
...
//RsPaise(Math.round(document.getElementById('number').value*100)/100);
