...
class ClientcompaniesFormRequest extends FormRequest
{
    /**
    ...
    {
        $data = $this->only(['cmpcode', 'cmpname', 'cmpmailingname', 'cmpaddress', 'cmpgstino', 'cmpcountry', 'cmpstate', 'cmpcity', 'cmpemail', 'cmpphoneno', 'cmpmobileno', 'cmpwebsite', 'cmplogo']);
