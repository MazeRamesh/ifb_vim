...
public function Import(Request $request)
{
    ...
    // dd($salesheader);
        ...
        $salesheader=$salesheader->map(function($row){
            ...
            $row['status_html']=$row['status']=="old"?"<h5><span class='badge badge-lg badge-info text-large mt-3 ml-4'>Already Imported</span><h5>":"<h5><span class='badge badge-success mt-3 ml-4'>New</span></h5><div></div>";
