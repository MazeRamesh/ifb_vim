...
class DropDownsController extends Controller
{
    ...
    public function getIndexData(Request $req)
    {
        ...
        ->addColumn('actions', function ($row) {
            ...
            return '<div class="btn-group btn-group-sm float-right" role="group">
                    <a href="' . route('drop_downs.drop_downs.show', [$row->id]) . '" class="btn btn-sm btn-warning text-white" title="Show DropDowns">
                        <i class="fa fa-eye" aria-hidden="true"></i>
                    </a>
                    <a href="' . route('drop_downs.drop_downs.edit', [$row->id]) . '" class="btn btn-sm btn-info text-white" title="Edit DropDowns">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <button type="submit" class="btn btn-sm btn-danger btn-delete" title="Delete DropDowns" data-remote="' . route('drop_downs.drop_downs.destroy', [$row->id]) . '" >
    ...
    public function edit($id)
    {
        ...
        return view('drop_downs.edit', compact('dropDowns'));
    }
