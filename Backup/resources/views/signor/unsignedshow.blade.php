...
@section('content')
  ...
  <br>
   <input name="invoicenumber1" id="invoicenumber" value="{{$salesheader->invoiceno}}" style="display: none;"/>
            ...
            @foreach($salesheader->InvoicenoList as $salesheader)
                        <tbody>
                            <tr>
                                ...
                                <td style="width:15%;">{{$salesheader->productpartno}}</td>
