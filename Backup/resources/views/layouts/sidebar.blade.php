<aside class="main-sidebar sidebar-light-primary elevation-4">
  <a style="padding: 0px;margin: 0px;" href="{!! url('http://mazeworkssolutions.com/') !!}" target="_blank" class="brand-link">
      <img style="padding:0px;height:55px;width:250px" src="{{ asset('img/Logo.jpg') }}"
