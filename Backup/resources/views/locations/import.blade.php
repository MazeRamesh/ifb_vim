			...
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Import Location</h3>
                  ...
                  <div class="container">
                      ...
                      <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ route('locations.location.locationExcelImport') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                        {!! csrf_field() !!}
