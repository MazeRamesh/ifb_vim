		...
		<th>Is Active</th>
                 ...
                 <tbody>
                    @foreach($configs as $config)
                        <tr>
                          <form method="POST" action="{{ route('configurations.configurations.update', $config->id) }}" name="edit_config_form" > 
                    ...
                    <td>                             
                        <div class="btn-group btn-group-xs pull-right" role="group">  
                           <input name="_method" type="hidden" value="PUT">  
                             ...
                             <button type="submit"  class="btn btn-sm btn-success savebutton"  title="Save Company">
