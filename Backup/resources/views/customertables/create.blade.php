...
@section('page-title','Customertables New')
        ...
        <div class="row">
			<div class="col-12 mt-3">
				<div class="card card-primary card-outline">
					<form method="POST" action="{{ route('customertables.customertables.store') }}" accept-charset="UTF-8" id="create_customertables_form" name="create_customertables_form" class="form-horizontal">
